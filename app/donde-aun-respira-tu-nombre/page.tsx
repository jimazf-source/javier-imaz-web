...
const estaciones = [
  {
    numero: "I",
    title: "El nacimiento del amor",
    poemas: "6 poemas",
    text: "Cuando el amor aparece sin saber que será memoria.",
  },
  {
    numero: "II",
    title: "La intensidad",
    poemas: "5 poemas",
    text: "Cuando el amor parece infinito.",
  },
  {
    numero: "III",
    title: "La ruptura",
    poemas: "5 poemas",
    text: "Cuando aparecen las primeras grietas.",
  },
  {
    numero: "IV",
    title: "La caída",
    poemas: "5 poemas",
    text: "Cuando el amor se derrumba.",
  },
  {
    numero: "V",
    title: "El duelo",
    poemas: "6 poemas",
    text: "Cuando la ausencia comienza a instalarse.",
  },
  {
    numero: "VI",
    title: "La memoria",
    poemas: "9 poemas",
    text: "Cuando el amor sobrevive en el recuerdo.",
  },
  {
    numero: "VII",
    title: "La permanencia",
    poemas: "4 poemas",
    text: "Cuando el amor ya no existe, pero permanece.",
  },
  {
    numero: "VIII",
    title: "Trascendencia",
    poemas: "12 poemas",
    text: "Cuando el amor se convierte en palabra.",
  },
];
...
const dimensiones = [
  {
    numero: "01",
    label: "Palabra",
    title: "52 poemas comentados",
    text: "Verso libre de arquitectura rigurosa —cinco estrofas de cinco versos—, cada uno seguido de un comentario crítico del propio autor que revela su mecánica simbólica.",
  },
  {
    numero: "02",
    label: "Imagen",
    title: "52 láminas originales",
    text: "Ilustraciones en tinta del autor: figuras solitarias, blancos habitados y un hilo rojo que recorre el libro como emblema del amor que insiste en permanecer.",
  },
  {
    numero: "03",
    label: "Música",
    title: "52 piezas para escuchar",
    text: "Un código QR junto a cada poema permite escucharlo interpretado y acompañado de música, sumergiendo al lector en una experiencia íntima, visual y sonora.",
  },
];
    ...
    <>
        ...
        <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[360px_1fr]">
            ...
            <div className="sticky top-28 overflow-hidden border border-gold/20 bg-panel">
              ...
              <dl className="space-y-4 p-7 text-sm">
                <div>
                  ...
                  <dd className="mt-1 text-parchment">NPQ Editores</dd>
                </div>
                <div>
                  <dt className="text-muted">Primera edición</dt>
                  <dd className="mt-1 text-parchment">Junio 2026</dd>
                </div>
                <div>
                  <dt className="text-muted">ISBN</dt>
                  <dd className="mt-1 text-parchment">979-13-88234-17-0</dd>
                </div>
                <div>
                  <dt className="text-muted">Estructura</dt>
                  <dd className="mt-1 text-parchment">52 poemas · 8 estaciones</dd>
                </div>
              </dl>
            </div>
          </Reveal>
          ...
          <div>
            <Reveal>
              <SectionHeading
                eyebrow="Sinopsis"
                title="El amor que no se olvida porque nunca se vivió del todo."
              />
              <div className="mt-9 space-y-6 text-lg leading-9 text-parchment">
                <p>
                  El amor no siempre encuentra su destino en el tiempo. A veces
                  encuentra su forma en la memoria. Donde aún respira tu nombre
                  es una obra singular en el panorama de la poesía contemporánea
                  en lengua española.
                </p>
                <p>
                  No es únicamente un poemario: es un mapa emocional de alta
                  precisión, trazado sobre el territorio invisible que deja un
                  amor que no llega a cumplirse del todo. Javier Imaz Fandos
                  construye una arquitectura poética de 52 poemas —cada uno
                  acompañado de un comentario crítico propio— que guía al lector
                  a través de ocho estaciones emocionales.
                </p>
                <p>
                  Un viaje completo que no termina con el olvido, sino con algo
                  más valioso: la integración.
                </p>
              </div>
            </Reveal>
      ...
      <section className="border-y border-parchment/10 bg-ink-soft px-5 py-20 sm:px-8 lg:py-28">
        <div className="mx-auto max-w-7xl">
          <Reveal>
            <SectionHeading
              eyebrow="El universo del poemario"
              title="Para leer, contemplar y escuchar"
              description="No es solo un poemario: es una experiencia artística y sensorial concebida para vivirse con todos los sentidos. Palabra, imagen y música se unen para dar forma a un universo propio."
              centered
            />
          </Reveal>
          ...
          <Reveal delay={120}>
            <div className="mt-14 border border-gold/20 bg-panel p-10 text-center">
              ...
              <p className="mx-auto mt-5 max-w-2xl text-lg leading-9 text-parchment">
                Las tres dimensiones de la obra —escritura, pintura y
                composición— son obra del propio Javier Imaz Fandos. Palabra,
                imagen y sonido nacen de una sola voz y convergen en un único
                universo poético.
              </p>
            </div>
          </Reveal>
      ...
      <section className="px-5 py-20 sm:px-8 lg:py-28">
        <div className="mx-auto max-w-7xl">
          <Reveal>
            <SectionHeading
              eyebrow="Vídeos del libro"
              title="Donde aún respira tu nombre en movimiento"
              description="Próximamente, piezas audiovisuales para entrar en el universo sonoro y visual del poemario."
              centered
            />
          </Reveal>
          <Reveal delay={90}>
            <div className="mt-14 flex items-center justify-center border border-gold/20 bg-panel/45 p-20">
              <p className="text-center font-display text-3xl italic text-parchment/50">
                Vídeos próximamente
              </p>
            </div>
          </Reveal>
        ...
        <div className="mx-auto max-w-7xl">
          <Reveal>
            <SectionHeading
              ...
              title="Imágenes de Donde aún respira tu nombre"
              description="Portada, láminas interiores y materiales del poemario. La galería se irá completando."
              centered
            />
          </Reveal>
